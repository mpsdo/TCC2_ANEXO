CREATE OR REPLACE FUNCTION COMPLEXIDADE_V4()
RETURNS void AS $$
DECLARE
...
BEGIN
    ...
    VALUES (fim_otimizado, fim_nao_otimizado, 'COMPLEXIDADE_OTM_V4', 'COMPLEXIDADE_NOT_OTM_V4');
END;
$$ LANGUAGE plpgsql;