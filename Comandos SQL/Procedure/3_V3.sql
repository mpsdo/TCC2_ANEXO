CREATE OR REPLACE PROCEDURE EXECUTA_V3()
LANGUAGE plpgsql
AS $$
DECLARE
    inicio TIMESTAMP;
...
BEGIN
    ...
    PERFORM * FROM "DADOSNASCIDO_OTM_V3";  -- Substitua 'view1' pelo nome real da sua view
    fim := clock_timestamp();
    ...
    VALUES (NOW(), tempo_exec1, tempo_exec2, 'DADOSNASCIDO_OTM_V3', 'COMPLEXIDADE_NOT_OTM_V4');
END;
$$;